...
def getmodel() -> Model:
    ...
    slaveNodeRadius: int = masterNodeRadius
    ...
    model.circle(slavePoints[0], slaveNodeRadius, slaveNodeFillStroke)
    model.circle(masterPoints[1], masterNodeRadius, masterNodeFillStroke)
    model.circle(slavePoints[1], slaveNodeRadius, slaveNodeFillStroke)
    model.circle(masterPoints[2], masterNodeRadius, masterNodeFillStroke)
    model.circle(slavePoints[2], slaveNodeRadius, slaveNodeFillStroke)
    ...
    for p in slavePoints:
        model.arrowRotational(p, slaveNodeRadius * 2.5, Size(6, 4), arrowFillStroke, 45)
